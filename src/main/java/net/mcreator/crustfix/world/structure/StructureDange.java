...
package net.mcreator.crustfix.world.structure;
...
public class StructureDange extends ElementsDoorscrustfix.ModElement {
	public StructureDange(ElementsDoorscrustfix instance) {
		super(instance, 68);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (dimID == WorldGuildinglightworld.DIMID) {
			dimensionCriteria = true;
			isNetherType = WorldGuildinglightworld.NETHER_TYPE;
		}
		...
		if ((random.nextInt(1000000) + 1) <= 2000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("crustfix", "dange"));
				if (template == null)
					return;
