...
import net.mcreator.crustfix.procedure.ProcedureGlfloverMobplayerCollidesWithPlant;
...
public class BlockGlflover extends ElementsDoorscrustfix.ModElement {
	@GameRegistry.ObjectHolder("crustfix:glflover")
	public static final Block block = null;
	public BlockGlflover(ElementsDoorscrustfix instance) {
		super(instance, 13);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("crustfix:glflover", "inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (Biome.REGISTRY.getNameForObject(biome).equals(new ResourceLocation("crustfix:glbiome")))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		for (int i = 0; i < 20; i++) {
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(100F);
			setLightLevel(1F);
			setUnlocalizedName("glflover");
			setRegistryName("glflover");
		}
		...
		public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureGlfloverMobplayerCollidesWithPlant.executeProcedure($_dependencies);
			}
		}
	}
}
