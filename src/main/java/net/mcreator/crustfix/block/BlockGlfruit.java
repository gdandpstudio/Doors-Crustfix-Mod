...
public class BlockGlfruit extends ElementsDoorscrustfix.ModElement {
	@GameRegistry.ObjectHolder("crustfix:glfruit")
	public static final Block block = null;
	public BlockGlfruit(ElementsDoorscrustfix instance) {
		super(instance, 17);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glfruit"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("crustfix:glfruit", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("glfruit");
