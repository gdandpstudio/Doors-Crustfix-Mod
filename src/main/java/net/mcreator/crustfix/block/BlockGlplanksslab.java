...
public class BlockGlplanksslab extends ElementsDoorscrustfix.ModElement {
	@GameRegistry.ObjectHolder("crustfix:glplanksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("crustfix:glplanksslab_double")
	public static final Block block_slab_double = null;
	public BlockGlplanksslab(ElementsDoorscrustfix instance) {
		super(instance, 21);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glplanksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("glplanksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("crustfix:glplanksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("glplanksslab");
