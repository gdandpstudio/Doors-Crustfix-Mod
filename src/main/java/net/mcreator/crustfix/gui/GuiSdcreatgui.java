...
package net.mcreator.crustfix.gui;
...
import net.mcreator.crustfix.procedure.ProcedureCreatesd;
...
public class GuiSdcreatgui extends ElementsDoorscrustfix.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiSdcreatgui(ElementsDoorscrustfix instance) {
		super(instance, 78);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 40, 8) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemEmprysd.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 127, 8) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 83, 61) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Doorscrustfix.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("crustfix:textures/sdcreatgui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 59, this.guiTop + 31, 60, 20, "Create"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			Doorscrustfix.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureCreatesd.executeProcedure($_dependencies);
			}
		}
	}
