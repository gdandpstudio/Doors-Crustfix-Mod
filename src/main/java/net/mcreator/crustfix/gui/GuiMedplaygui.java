...
import net.mcreator.crustfix.procedure.ProcedureMEDSTOPBUT;
import net.mcreator.crustfix.procedure.ProcedureMEDPLAYBUT;
...
public class GuiMedplaygui extends ElementsDoorscrustfix.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiMedplaygui(ElementsDoorscrustfix instance) {
		super(instance, 70);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 24, 60) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("crustfix:textures/medplaygui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 50, this.guiTop + 57, 40, 20, "PLAY"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 96, this.guiTop + 57, 40, 20, "STOP"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureMEDPLAYBUT.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				ProcedureMEDSTOPBUT.executeProcedure($_dependencies);
			}
		}
	}
